...
class AutoRebalancer:
    ...
    def __init__(
        ...
        min_transaction_amount: int = 100000,
    ...
    def _calculate_risk_parity_weights(
        ...
        for holding in holdings:
            ...
            volatilities[holding.get('stock_code')] = max(change_rate, 0.1)
    ...
    def _calculate_momentum_weights(
        ...
        for holding in holdings:
            ...
            returns[holding.get('stock_code')] = max(profit_rate, 0)
    ...
    def _calculate_ai_weights(
        ...
        scores = {}
        for holding in holdings:
            ai_score = holding.get('ai_score', 5.0)
