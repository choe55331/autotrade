...
def calculate_volatility_score(prices: pd.Series,
    ...
    if current_price >= current_upper:
        ...
        scores.append(80)  # High volatility
        ...
        scores.append(40)  # Low volatility
    ...
    # ATR Analysis (if high/low provided)
    if high is not None and low is not None:
        ...
        # Calculate ATR relative to its MA
...
def calculate_dynamic_take_profit(entry_price: float,
    ...
    Returns:
        Take-profit price
    """
    # Calculate ATR-based profit distance
...
def calculate_volatility_breakout(prices: pd.Series,
    ...
    # Check current price against levels
    current_price = prices.iloc[-1]
